...
class AppConstants {
  static const linkedInUrl =
      "https://www.linkedin.com/in/muhammad-ahmed-b01749150/";
  static const instagramUrl = "https://www.instagram.com/ahmedkhan_4u?igsh=YjY1aDRneXY2Mmll/";
  static const githubUrl = "https://github.com/ahmedkhan4u/";
  static const mediumUrl = "https://medium.com/@ahmed.dev098/";
...
//   static const _socialImages = _images + "social/";
  ...
  static const databaseImage = _techImages + "database.png";
  ...
  static const babyCareImage = _projectsImages + "baby_care.webp";
  static const medicaReminderImage = _projectsImages + "medica_reminder.webp";
  static const scamSpyImage = _projectsImages + "scam_spy.webp";
  static const cmsRicImage = _projectsImages + "cms_ric.png";
  static const empleadoImage = _projectsImages + "empleado.webp";
  static const accelerateImage = _projectsImages + "accelerate.webp";
  static const scribbleImage = _projectsImages + "scribble.png";
